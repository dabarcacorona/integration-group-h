...
public class setDownloadIPHY {
    ...
    @Value("${sftpos.org_IPHY}")
    private String o_sftpdtn_IPHY;
    ...
    public void DownloadFile() throws IOException {
        ...
        try {
            ...
            Vector<ChannelSftp.LsEntry> entries = sftp.ls(o_sftpdtn_IPHY);
            ...
            for (ChannelSftp.LsEntry en : entries) {
                ...
                if (sSubCadena.equals("SDIPHYDTI")) {
                    LOG.info("Downloading IPHY " + (o_sftpdtn_IPHY + en.getFilename()) + " ---> " + pathdest + en.getFilename() + " Conteo PWC a PMM");
                    sftp.get(o_sftpdtn_IPHY + en.getFilename(), pathdest + en.getFilename());
                    sftp.rm(o_sftpdtn_IPHY + en.getFilename());
