...
public class setDownloadIRTV {
    ...
    @Value("${sftpos.org_IRTV}")
    private String o_sftpdtn_IRTV;
    ...
    public void DownloadFile() throws IOException {
        ...
        try {
            ...
            Vector<ChannelSftp.LsEntry> entries = sftp.ls(o_sftpdtn_IRTV);
            ...
            for (ChannelSftp.LsEntry en : entries) {
                ...
                if (sSubCadena.equals("SDIRTVDTI")) {
                    LOG.info("Downloading IRTV " + (o_sftpdtn_IRTV + en.getFilename()) + " ---> " + pathdest + en.getFilename());
                    sftp.get(o_sftpdtn_IRTV + en.getFilename(), pathdest + en.getFilename());
                    sftp.rm(o_sftpdtn_IRTV + en.getFilename());
